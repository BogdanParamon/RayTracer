...
float areaTriangle(const glm::vec3& v0, const glm::vec3& v1, const glm::vec3& v2)
{
    return 0.5f * glm::length(glm::cross(v2 - v0, v1 - v0));
}
...
glm::vec3 computeBarycentricCoord(const glm::vec3& v0, const glm::vec3& v1, const glm::vec3& v2, const glm::vec3& p)
{
    ...
    float alpha = areaTriangle(p, v1, v2) / area;
    float beta = areaTriangle(p, v0, v2) / area;
    float gamma = areaTriangle(p, v0, v1) / area;

    glm::vec3 result = {alpha, beta, gamma};
...
glm::vec3 interpolateNormal(const glm::vec3& n0, const glm::vec3& n1, const glm::vec3& n2, const glm::vec3 bc)
{
    ...
    glm::vec3 result = n0 * bc[0] + n1 * bc[1] + n2 * bc[2];
...
glm::vec2 interpolateTexCoord(const glm::vec2& t0, const glm::vec2& t1, const glm::vec2& t2, const glm::vec3 bc)
{
    ...
    glm::vec2 result = t0 * bc[0] + t1 * bc[1] + t2 * bc[2];
